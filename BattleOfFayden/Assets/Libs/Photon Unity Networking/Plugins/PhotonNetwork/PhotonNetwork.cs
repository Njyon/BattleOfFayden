...
public static class PhotonNetwork
{
    ...
    private static int sendInterval = 20; // in miliseconds.

    private static int sendIntervalOnSerialize = 80; // in miliseconds. I.e. 100 = 100ms which makes 10 times/second
