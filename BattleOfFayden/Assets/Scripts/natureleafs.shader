...
Shader "Nature/Transparent/Leafshader"
{
    Properties
    {
        ...
        _MetallicStrength ("Metallic Glossiness", Range(0,1)) = 0.5
        _SpecMap ("Specularity Texture", 2D) = "white" {}
        _Smoothness ("Smoothness", Range(0,1)) = 0.5
        _Illum ("Illumination Texture", 2D) = "white" {}
...
#pragma surface surf Standard alphatest:_Cutoff vertex:vert addshadow
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Albedo 		= c.rgb;
            o.Metallic 		= metal.r * _MetallicStrength;
